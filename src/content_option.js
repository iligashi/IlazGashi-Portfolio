...
const dataabout = {
    ...
    aboutme: "Enthusiastic junior developer skilled in full-stack development with experience in HTML, CSS, JavaScript, and React. Eager to contribute to collaborative projects and grow within a professional development team.",
};
const worktimeline = [{
        jobtitle: "Freelancer",
        where: "Home",
    ...
    {
        jobtitle: "Junior General Tech Engineer ",
        where: "Digital School",
        date: "2025",
    },
];
...
const services = [{
        title: "Websites",
        description: " I create modern, responsive websites that deliver a seamless user experience.",
    },
    {
        title: "Management Systems",
        description: "I develop efficient management systems to streamline business operations and improve productivity.",
    },
    {
        title: "Apps",
        description: "I build user-friendly applications tailored to your needs, ensuring functionality and great performance.",
    },
];
